...
## Importância da variáveis estimada por modelo Random Forest
```{r}
set.seed(1)
...
ptm <- proc.time()
fit <- train(ESPVIDA ~ ., data=data, method="rf", preProcess="scale", trControl=control)
proc.time() - ptm
fit
```
...
>>>>>>> 030bf54727436dbcb967c0771f8cd977d86ce4bd
ptm <- proc.time()
